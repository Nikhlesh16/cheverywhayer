    ...
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-start gap-3">
          ...
          <button
            onClick={() => {
              const { setMobileView } = useRegionStore.getState();
              setMobileView('workspaces');
            }}
            className="md:hidden w-10 h-10 flex items-center justify-center text-gray-600 hover:bg-gray-100 rounded-lg flex-shrink-0"
          >
